...
-(void)setValuesForYAxis:(Chart *)chart serie:(NSDictionary *)serie{
    ...
    float high = [data[chart.rangeFrom][2] floatValue];
    float low = [data[chart.rangeFrom][3] floatValue];
...
-(void)setLabel:(Chart *)chart label:(NSMutableArray *)label forSerie:(NSMutableDictionary *) serie{
    ...
    if(chart.selectedIndex!=-1 && chart.selectedIndex < data.count && data[chart.selectedIndex]!=nil){
        float high  = [data[chart.selectedIndex][2] floatValue];
        float low   = [data[chart.selectedIndex][3] floatValue];
        float open  = [data[chart.selectedIndex][0] floatValue];
        float close = [data[chart.selectedIndex][1] floatValue];
